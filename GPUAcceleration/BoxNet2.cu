                    ...
                    uint batch)
{
    ...
    BoxNet2AugmentKernel << <grid, 128 >> > (t_inputmic, d_inputlabel, d_inputuncertain, dimsinput, d_outputmic, d_outputlabel, d_outputweights, dimsoutput.x, labelweights, d_offsets, d_transforms, channelsfirst);
