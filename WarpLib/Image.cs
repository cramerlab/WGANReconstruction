...
namespace Warp
{
    public class Image : IDisposable
    {
        ...
        public Image AsRegion(int3 origin, int3 dimensions)
        {
            ...
            Image Result = new Image(Region, dimensions, IsFT, IsComplex, IsHalf);
            Result.Parent = this;
        ...
        public Image AsFFT_CPU()
        {
            ...
            Image Result = new Image(Helper.FromInterleaved2(Transformed), Dims, true);
        ...
        public Image AsIFFT_CPU()
        {
            ...
            Image Result = new Image(Transformed, Dims);
            Result.Parent = this;
        ...
        public Image AsReal()
        {
            ...
            Image Result = new Image(Real, Dims, IsFT, false, IsHalf);
        ...
        public Image AsImaginary()
        {
            ...
            Image Result = new Image(Imaginary, Dims, IsFT, false, IsHalf);
        ...
        public Image AsDilatedMask(float distance)
        {
            ...
            Image Result = new Image(DistanceMapData, Dims);
        ...
        public Image AsSpectrumFlattened(bool isVolume = true, float nyquistLowpass = 1f, int spectrumLength = -1)
        {
            ...
            Image IFT = (isVolume ? FT.AsIFFT_CPU() : FT.AsIFFT(false)).AndDisposeParent();
        ...
        public Image AsRotated3D(float3 angles, int supersample = 1)
        {
            ...
            Projector P = new Projector(this, supersample, 3);
