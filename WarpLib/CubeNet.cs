...
namespace Warp
{
    public class CubeNet : IDisposable
    {
        ...
        public float[] Segment(Image volume, float threshold, Func<int3, int, string, bool> progressCallback)
        {
        ...
        public float4[] Match(Image volume, float diameterAngstrom, float threshold, Func<int3, int, string, bool> progressCallback)
        {
            ...
            float[] Predictions = Segment(volume, threshold, progressCallback);
