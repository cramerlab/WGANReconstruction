...
namespace Warp
{
    public class TildeNet : IDisposable
    {
        ...
        private TorchTensor[] AtomIntensities;

        private TorchTensor AtomPositions;
        private TorchTensor AtomPositionsEncoded;

        private MLP ModelEncoder;
        private MLP[] ModelsDecoder;

        private UNet2D ModelRegularizerParticle;
        private UNet3D ModelRegularizerDisplacement;
        private UNet3D ModelRegularizerMap;

        private TorchTensor TensorParticlesEncoder;
        private TorchTensor TensorCTFEncoder;
        private TorchTensor TensorPixelMappingEncoder;

        private TorchTensor TensorParticlesDecoder;
        private TorchTensor TensorCTFDecoder;
        ...
        public TildeNet(int nframes,
                        int boxSizeEncoder,
                        int boxSizeFull,
                        float3[] atomPositions, 
                        int encoderInputs, 
                        int encoderLength, 
                        int codeLength, 
                        int positionEncodingComponents,
                        int decoderWidth, 
                        int decoderLength, 
                        int deviceAutoencoder, 
                        int deviceRegularizer, 
                        int batchSize = 8)
        {
            Devices = devices;
