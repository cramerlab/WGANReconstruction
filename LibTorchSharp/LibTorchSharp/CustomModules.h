...
EXPORT_API(void)     THSNN_ReconstructionWGANGenerator_clip_gradient(const NNModule module, const float clip_Value);
...
EXPORT_API(void) THSNN_ReconstructionWGANDiscriminator_clip_gradient(const NNModule module, const float clip_Value);
