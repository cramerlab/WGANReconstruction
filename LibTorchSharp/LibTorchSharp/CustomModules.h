...
EXPORT_API(Tensor) THSNN_FFTCrop(const Tensor fft_volume, int new_x, int new_y, int new_z);
EXPORT_API(Tensor) THSNN_new_FFTCrop(const Tensor fft_volume, int dim, int new_x, int new_y, int new_z);
