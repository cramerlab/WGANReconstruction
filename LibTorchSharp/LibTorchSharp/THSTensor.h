...
EXPORT_API(void) THSTensor_backward(Tensor tensor, Tensor gradient, bool retain_graph);
...
EXPORT_API(Tensor) THSTensor_softmax(const Tensor tensor, int64_t dim);
...
EXPORT_API(void) THSTensor_scatter_to_devices(const Tensor tensor, const int64_t dim, const int64_t* devices, const int64_t ndevices, Tensor* scattered_tensors);

EXPORT_API(Tensor) THSTensor_gather_from_devices(const int64_t dim, const int64_t ndevices, const int64_t dest_device, const Tensor* scattered_tensors);
...
EXPORT_API(Tensor) THSTensor_pad(const Tensor tensor, int64_t* pad, int64_t npad);
